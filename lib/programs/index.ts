...
import { STARTING_STRENGTH_METADATA } from "./startingStrength";

export * from "./types";

export const PROGRAM_IDS: ProgramId[] = ["wendler531", "texasMethod", "startingStrength"];

export const PROGRAMS: Record<ProgramId, ProgramMetadata> = {
  wendler531: WENDLER531_METADATA,
  texasMethod: TEXAS_METHOD_METADATA,
  startingStrength: STARTING_STRENGTH_METADATA,
};
...
export function isProgramId(value: unknown): value is ProgramId {
  return value === "wendler531" || value === "texasMethod" || value === "startingStrength";
}
